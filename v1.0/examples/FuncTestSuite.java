...
public class FuncTestSuite {
	...
	private static final org.drip.product.credit.Bond CreateSimpleBond (final java.lang.String strName, final
		...
		org.drip.param.product.BondIRValuationParams irValParams = new
			org.drip.param.product.BondIRValuationParams (strCurrency, "", "", dtEffective.getJulian(), 1.,
				3, strCurrency, org.drip.analytics.daycount.DayCountBasis.DR_MOD_FOLL);
		...
		org.drip.param.product.BondPeriodGenerationParams periodParams = new
			org.drip.param.product.BondPeriodGenerationParams (dtMaturity.getJulian(),
				dtEffective.getJulian(), java.lang.Double.NaN, dtEffective.getJulian(),
					dtEffective.getJulian(), 2, "30/360", "30/360", null, null, null, null, null, null, null,
						null, "", false, strCurrency);
	...
	private static final boolean addTSYToMPC (final org.drip.param.market.MarketParamsContainer mpc) {
		try {
			...
			org.drip.product.quote.Quote qPxBRA_5_00_21 = new org.drip.product.quote.Quote ("bid", 0.74);
	...
	private static final void BuildTSYCurve (final org.drip.util.date.JulianDate dt, final
		...
		if (TD_SUCCESS_FAILURE == iTestDetail)
			...
			System.out.println ("Base TSY DC: " + dcBaseTSY.toString());
	...
	private static void testDC (org.drip.param.market.MarketParamsContainer mpc, final
		...
		if (TD_SUCCESS_FAILURE == iTestDetail)
			...
			System.out.println ("Base DC: " + dcBase.toString());
	...
	public static void testCC (org.drip.param.market.MarketParamsContainer mpc, final
		...
		org.drip.param.pricer.PricerParams pricerParams = new org.drip.param.pricer.PricerParams (7, true,
		...
		ccscARG.cookScenarioCC ("ARG", valParams, dc, null, null, adblQuotesARG, 0.4, astrCalibMeasure, null,
			null, false, 63);
		...
		ccscBRA.cookScenarioCC ("BRA", valParams, dc, null, null, adblQuotesBRA, 0.4, astrCalibMeasure, null,
			null, false, 63);
	...
	private static void testCDS (final org.drip.param.market.MarketParamsContainer mpc, final
		...
		org.drip.calc.output.ComponentOutput cdsOut = cds.calcMeasures (new
			org.drip.param.valuation.ValuationParams (dt, dt, "USD"), new org.drip.param.pricer.PricerParams (7,
				false, false, org.drip.param.pricer.PricerParams.PERIOD_DISCRETIZATION_DAY_STEP), mpc, null);
	...
	private static void testFixedCouponBond (final org.drip.param.market.MarketParamsContainer mpc, final
		...
		org.drip.product.credit.Bond bond = CreateSimpleBond ("BRA_5.00_21", dt,
			org.drip.util.date.JulianDate.CreateFromYMD (2021, 6, 20), 0.05, "USD", "BRA", "BRA");
		...
		org.drip.calc.output.ComponentOutput bondOut = bond.calcMeasures (new
			org.drip.param.valuation.ValuationParams (dt, dt, "USD"), new org.drip.param.pricer.PricerParams
				(7, false, false, org.drip.param.pricer.PricerParams.PERIOD_DISCRETIZATION_DAY_STEP), mpc,
					null);
	...
	private static void testBasketDefaultSwap (final org.drip.param.market.MarketParamsContainer mpc, final
		...
		org.drip.param.pricer.PricerParams pricerParams = new org.drip.param.pricer.PricerParams (7, false,
			false, org.drip.param.pricer.PricerParams.PERIOD_DISCRETIZATION_DAY_STEP);
	...
	private static final void AnalSim (final int iTestDetail, final int iTestProduct, final int
		...
		org.drip.util.date.JulianDate dt = org.drip.util.date.JulianDate.CreateFromYMD (2011, 5, 20);
	...
	public static void main (java.lang.String astrArgs[]) throws java.lang.Exception {
		...
		/* int iTestProduct = TP_FIXED_BOND | TP_CDS;
		int iTestMode = 0; */
		int iTestProduct = TP_CASH | TP_EDF | TP_IRS | TP_CDS | TP_FIXED_BOND | TP_CDX;
