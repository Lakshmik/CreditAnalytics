...
public class FuncTestSuite {
	...
	private static final boolean addTSYToMPC (final org.drip.param.market.MarketParamsContainer mpc) {
		try {
			...
			org.drip.product.quote.Quote qPxBRA_5_00_21 = new org.drip.product.quote.Quote ("bid", 1.000);

			qPxBRA_5_00_21.setSide ("mid", 1.000);

			qPxBRA_5_00_21.setSide ("ask", 1.000);
