...
public class FIFull {
	...
	private static final boolean s_bTickerAnalDisplay = true;
	...
	public static final void BondTickerAPISample() {
		...
		if (s_bTickerAnalDisplay) {
			System.out.println
				("Dumping: ISIN, Bond, FIX/FLT, Yield, Z Spread, Disc Margin, TSY Spread, Credit Basis, Credit Price");
																...
																(dblDiscountMarginFromPrice) + "    " +
																	org.drip.util.common.FIGen.FormatSpread
																		(dblTSYSpreadFromPrice) + "    " +
																			org.drip.util.common.FIGen.FormatSpread
							(dblCreditBasisFromPrice) + "    " + org.drip.util.common.FIGen.FormatPrice
								(dblBondCreditPrice));
				} catch (java.lang.Exception e) {
					if (s_bSupressErrMsg) {
	...
	public static final void BasketCDSAPISample() {
		...
		org.drip.product.credit.BasketProduct bpCDXOTR = org.drip.service.api.FI.MakeCDX ("CDX.NA.IG",
			org.drip.util.date.JulianDate.Today(), "5Y");
