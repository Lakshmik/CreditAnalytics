...
public class CDSBasketAPISample {
	...
	public static final void BasketCDSAPISample() {
		...
		BasketProduct bpCDX = FI.MakeCDX ("CDX.NA.IG", 17, "5Y");

		/*
		 * Construct the on-the-run CDX.NA.IG 5Y Series 17 index
		 */

		BasketProduct bpCDXOTR = FI.MakeCDX ("CDX.NA.IG", dtToday, "5Y");
		...
		BasketProduct bpPresetOTR = StandardCDXManager.GetOnTheRun ("CDX.EM", dtToday.subtractTenor ("1Y"),
			"5Y");
