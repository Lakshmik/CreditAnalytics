...
public class SerializerTestSuite {
		...
		throws java.lang.Exception
	{
		...
		Verify (abDC, org.drip.analytics.creator.DiscountCurveBuilder.FromByteArray (abDC), "DiscountCurve");
		...
		byte[] abNEI = new org.drip.param.valuation.ExerciseInfo (dblStart, 1.,
			org.drip.param.valuation.WorkoutInfo.WO_TYPE_MATURITY).serialize();

		Verify (abNEI, new org.drip.param.valuation.ExerciseInfo (abNEI), "NextExerciseInfo");
