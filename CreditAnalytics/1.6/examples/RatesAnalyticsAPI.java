...
public class RatesAnalyticsAPI {
		...
		throws Exception
	{
		...
		DiscountCurve dc = RatesScenarioCurveBuilder.CreateDiscountCurve (dtStart, "USD", aCompCalib, adblCompCalibValue,
		...
		for (int i = 0; i < aCompCalib.length; ++i)
			System.out.println (astrCalibMeasure[i] + "[" + i + "] = " + aCompCalib[i].calcMeasureValue
				(new ValuationParams (dtStart, dtStart, "USD"), null,
					ComponentMarketParamsBuilder.CreateComponentMarketParams (dc, null, null, null, null, null,
