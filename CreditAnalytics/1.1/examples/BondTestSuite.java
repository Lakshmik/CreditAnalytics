...
public class BondTestSuite {
	private static final int UPDATE_EOD_CREDIT_MEASURES = 1;
	private static final int UPDATE_EOD_SET_CREDIT_MEASURES = 2;
	private static final int UPDATE_EOD_BOND_MEASURES = 3;
	private static final int UPDATE_EOD_SET_BOND_MEASURES = 4;

	private static final int s_iEODMode = UPDATE_EOD_BOND_MEASURES;
	...
	public static void main (java.lang.String astrArgs[]) throws java.lang.Exception {
		...
		if (UPDATE_EOD_SET_CREDIT_MEASURES == s_iEODMode) {
			org.drip.service.env.CDSManager.CalcAndLoadCDSClosingMeasures (stmt, dt, dtEnd);

			return;
		}

		if (UPDATE_EOD_CREDIT_MEASURES == s_iEODMode) {
		...
		if (UPDATE_EOD_SET_BOND_MEASURES == s_iEODMode) {
			org.drip.service.env.BondManager.CalcAndLoadBondClosingMeasures (mpc, stmt, dt, dtEnd);

			return;
		}

		// java.lang.String strBondSetID = "CompleteSet";
		// java.lang.String strBondSetID = "US69563AFY29";
