...
/**
 * This class contains the hyperbolic tension forward bootstrapped discount curve holder object. It maintains
 * 	the term structure for the period begin rates, the calibration instruments, the calibration measures,
 * 	the calibration quotes, and the parameters.
 *
 * @author Lakshmi Krishnamurthy
 */

public class HyperbolicTensionForwardRate extends org.drip.analytics.definition.DiscountCurve {
	...
	private HyperbolicTensionForwardRate (
	 ...
	 * @param adblDate Array of node dates
	 * 
	 * @throws java.lang.Exception Thrown if the inputs are invalid
	 */

	public HyperbolicTensionForwardRate (
		final org.drip.analytics.date.JulianDate dtStart,
		final java.lang.String strCurrency,
		final double[] adblDate)
		throws java.lang.Exception
		...
		throws java.lang.Exception
	{
		if (null == adblDate || 0 == adblDate.length || null == adblEndRate || adblDate.length !=
			...
			throw new java.lang.Exception ("Invalid inputs into HyperbolicTensionForwardRate constructor");
	...
	protected HyperbolicTensionForwardRate (
		final HyperbolicTensionForwardRate dc)
		throws java.lang.Exception
	{
		if (null == dc) throw new java.lang.Exception ("Invalid input HyperbolicTensionForwardRate");
	 ...
	 * @param ab Byte Array
	 * 
	 * @throws java.lang.Exception Thrown if HyperbolicTensionForwardRate cannot be properly de-serialized
	 */
		...
		throws java.lang.Exception
	{
		if (null == ab || 0 == ab.length)
			throw new java.lang.Exception
				("HyperbolicTensionForwardRate de-serializer: Invalid input Byte array");

		java.lang.String strRawString = new java.lang.String (ab);

		if (null == strRawString || strRawString.isEmpty())
			throw new java.lang.Exception ("HyperbolicTensionForwardRate de-serializer: Empty state");

		java.lang.String strSerializedHyperbolicTensionForwardRate = strRawString.substring (0,
			strRawString.indexOf (getObjectTrailer()));

		if (null == strSerializedHyperbolicTensionForwardRate ||
			strSerializedHyperbolicTensionForwardRate.isEmpty())
			throw new java.lang.Exception
				("HyperbolicTensionForwardRate de-serializer: Cannot locate state");

		java.lang.String[] astrField = org.drip.analytics.support.GenericUtil.Split
			(strSerializedHyperbolicTensionForwardRate, getFieldDelimiter());

		if (null == astrField || 4 > astrField.length)
			throw new java.lang.Exception
				("HyperbolicTensionForwardRate de-serializer: Invalid reqd field set");
		...
		if (null == astrField[1] || astrField[1].isEmpty() ||
			...
			throw new java.lang.Exception
				("HyperbolicTensionForwardRate de-serializer: Cannot locate start state");
		...
		if (null == astrField[2] || astrField[2].isEmpty() ||
			...
			throw new java.lang.Exception
				("HyperbolicTensionForwardRate de-serializer: Cannot locate currency");
		...
		if (null == astrField[3] || astrField[3].isEmpty() ||
			...
			throw new java.lang.Exception
				("HyperbolicTensionForwardRate de-serializer: Cannot decode state");
	...
	@Override public HyperbolicTensionForwardRate createParallelShiftedCurve (
		final double dblShift)
	{
		...
		HyperbolicTensionForwardRate dc = null;

		try {
			dc = new HyperbolicTensionForwardRate (new org.drip.analytics.date.JulianDate (_dblStartDate),
	...
	@Override public HyperbolicTensionForwardRate createParallelRateShiftedCurve (
		final double dblShift)
	{
		if (!org.drip.math.common.NumberUtil.IsValid (dblShift)) return null;
		...
		try {
			...
			return new HyperbolicTensionForwardRate (new org.drip.analytics.date.JulianDate (_dblStartDate),
	...
	@Override public HyperbolicTensionForwardRate createBasisRateShiftedCurve (
		final double[] adblDate,
		...
		throws java.lang.Exception
	{
		if (!org.drip.math.common.NumberUtil.IsValid (dblDate))
			throw new java.lang.Exception ("HyperbolicTensionForwardRate.getDF got NaN for date");
		...
		throws java.lang.Exception
	{
		if (null == dt1 || null == dt2)
			throw new java.lang.Exception ("HyperbolicTensionForwardRate.getEffectiveDF got null for date");
		...
		throws java.lang.Exception
	{
		if (null == strTenor1 || strTenor1.isEmpty() || null == strTenor2 || strTenor2.isEmpty())
			throw new java.lang.Exception ("HyperbolicTensionForwardRate.getEffectiveDF got bad tenor");
	...
	{
		if (!org.drip.math.common.NumberUtil.IsValid (dblDate))
			throw new java.lang.Exception ("HyperbolicTensionForwardRate.calcImpliedRate got NaN for date");
		...
		throws java.lang.Exception
	{
		if (null == strTenor || strTenor.isEmpty())
			throw new java.lang.Exception ("HyperbolicTensionForwardRate.getDF got empty date");
		...
		throws java.lang.Exception
	{
		...
		HyperbolicTensionForwardRate dc = new HyperbolicTensionForwardRate
		...
		HyperbolicTensionForwardRate dcDeser = (HyperbolicTensionForwardRate) dc.deserialize (abDC);
