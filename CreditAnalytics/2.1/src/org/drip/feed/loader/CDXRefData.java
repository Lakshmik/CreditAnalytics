...
public class CDXRefData {
		...
		final java.io.BufferedWriter bw)
	{
		...
		java.lang.String strCurveID = org.drip.analytics.support.GenericUtil.ProcessInputForNULL
			(astrArgs[0], false);

		if (s_bBlog) System.out.println ("Curve ID: " + strCurveID);

		java.lang.String strSPN = org.drip.analytics.support.GenericUtil.ProcessInputForNULL (astrArgs[1],
			false);

		if (s_bBlog) System.out.println ("SPN: " + strSPN);

		java.lang.String strIndexLabel = org.drip.analytics.support.GenericUtil.ProcessInputForNULL
			(astrArgs[2], false);

		if (s_bBlog) System.out.println ("Index Label: " + strIndexLabel);

		java.lang.String strIndexName = org.drip.analytics.support.GenericUtil.ProcessInputForNULL
			(astrArgs[3], false);

		if (s_bBlog) System.out.println ("Index Name: " + strIndexName);

		java.lang.String strCurveName = org.drip.analytics.support.GenericUtil.ProcessInputForNULL
			(astrArgs[4], false);
		...
		org.drip.analytics.date.JulianDate dtIssueDate =
			org.drip.analytics.support.AnalyticsHelper.MakeJulianFromDDMMMYY
				(org.drip.analytics.support.GenericUtil.ProcessInputForNULL (astrArgs[5], false), "-");
		...
		org.drip.analytics.date.JulianDate dtMaturityDate =
			org.drip.analytics.support.AnalyticsHelper.MakeJulianFromDDMMMYY
				(org.drip.analytics.support.GenericUtil.ProcessInputForNULL (astrArgs[6], false), "-");
		...
		java.lang.String strCurrency = org.drip.analytics.support.GenericUtil.ProcessInputForNULL
			(astrArgs[8], false);

		if (s_bBlog) System.out.println ("Currency: " + strCurrency);

		java.lang.String strDayCount = org.drip.analytics.support.GenericUtil.ProcessInputForNULL
			(astrArgs[9], false);

		if (s_bBlog) System.out.println ("DayCount: " + strDayCount);

		java.lang.String strFullFirstStub = org.drip.analytics.support.GenericUtil.ProcessInputForNULL
			(astrArgs[10], false);
		...
		java.lang.String strFrequency = org.drip.analytics.support.GenericUtil.ProcessInputForNULL
			(astrArgs[12], false);
		...
		java.lang.String strRedID = org.drip.analytics.support.GenericUtil.ProcessInputForNULL (astrArgs[13],
			false);

		if (s_bBlog) System.out.println ("RedID: " + strRedID);

		java.lang.String strIndexClass = org.drip.analytics.support.GenericUtil.ProcessInputForNULL
			(astrArgs[14], false);
		...
		java.lang.String strIndexGroupName = org.drip.analytics.support.GenericUtil.ProcessInputForNULL
			(astrArgs[16], false);

		if (s_bBlog) System.out.println ("Index Group Name: " + strIndexGroupName);

		java.lang.String strIndexShortName = org.drip.analytics.support.GenericUtil.ProcessInputForNULL
			(astrArgs[17], false);

		if (s_bBlog) System.out.println ("Index Short Name: " + strIndexShortName);

		java.lang.String strIndexShortGroupName = org.drip.analytics.support.GenericUtil.ProcessInputForNULL
			(astrArgs[18], false);
		...
		java.lang.String strCurvyCurveID = org.drip.analytics.support.GenericUtil.ProcessInputForNULL
			(astrArgs[21], false);
		...
		java.lang.String strLocation = org.drip.analytics.support.GenericUtil.ProcessInputForNULL
			(astrArgs[26], false);
		...
		java.lang.String strBBGTicker = org.drip.analytics.support.GenericUtil.ProcessInputForNULL
			(astrArgs[41], false);

		if (s_bBlog) System.out.println ("BBG Ticker: " + strBBGTicker);

		java.lang.String strShortName = org.drip.analytics.support.GenericUtil.ProcessInputForNULL
			(astrArgs[42], false);
