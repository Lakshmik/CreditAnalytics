...
public class VariateIteratorPrimitive {
	...
	{
		if (!org.drip.math.common.NumberUtil.IsValid (dblX1) || !org.drip.math.common.NumberUtil.IsValid
			(dblX2) || !org.drip.math.common.NumberUtil.IsValid (dblY1) ||
				!org.drip.math.common.NumberUtil.IsValid (dblY2))
	...
	{
		if (!org.drip.math.common.NumberUtil.IsValid (dblX1) || !org.drip.math.common.NumberUtil.IsValid
			(dblX2) || !org.drip.math.common.NumberUtil.IsValid (dblX3) ||
				!org.drip.math.common.NumberUtil.IsValid (dblY1) || !org.drip.math.common.NumberUtil.IsValid
					(dblY2) || !org.drip.math.common.NumberUtil.IsValid (dblY3))
		...
		throws java.lang.Exception
	{
		if (!org.drip.math.common.NumberUtil.IsValid (dblX1) || !org.drip.math.common.NumberUtil.IsValid
			(dblX2) || !org.drip.math.common.NumberUtil.IsValid (dblX3) ||
				!org.drip.math.common.NumberUtil.IsValid (dblY1) || !org.drip.math.common.NumberUtil.IsValid
					(dblY2) || !org.drip.math.common.NumberUtil.IsValid (dblY3) ||
						!org.drip.math.common.NumberUtil.IsValid (dblOFTarget) || null == rfop || null == of)
