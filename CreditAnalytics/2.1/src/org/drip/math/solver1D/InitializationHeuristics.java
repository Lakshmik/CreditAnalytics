...
public class InitializationHeuristics {
	...
	private org.drip.math.solver1D.BracketingControlParams _bcpCustom = null;
	...
	public static final InitializationHeuristics FromBracketingCustomBCP (
		final org.drip.math.solver1D.BracketingControlParams bcpCustom)
	{
		try {
		...
		throws java.lang.Exception
	{
		if (BRACKETING_EDGE_HINTS == (_iDeterminant = iDeterminant)) {
			if (!org.drip.math.common.NumberUtil.IsValid (_dblStartingBracketLeft = dblStartingBracketLeft)
				|| !org.drip.math.common.NumberUtil.IsValid (_dblStartingBracketRight =
			...
			if (!org.drip.math.common.NumberUtil.IsValid (_dblStartingBracketMid = dblStartingBracketMid))
				throw new java.lang.Exception
					("InitializationHeuristics constructor: Invalid BRACKETING_MID_HINT params!");
		} else if (BRACKETING_FLOOR_CEILING == _iDeterminant) {
			if (!org.drip.math.common.NumberUtil.IsValid (_dblBracketFloor = dblBracketFloor) ||
				!org.drip.math.common.NumberUtil.IsValid (_dblBracketCeiling = dblBracketCeiling))
				throw new java.lang.Exception
					("InitializationHeuristics constructor: Invalid BRACKETING_FLOOR_CEILING params!");
		} else if (SEARCH_HARD_BRACKETS == _iDeterminant) {
			if (!org.drip.math.common.NumberUtil.IsValid (_dblSearchStartLeft = dblSearchStartLeft) ||
				!org.drip.math.common.NumberUtil.IsValid (_dblSearchStartRight = dblSearchStartRight))
				throw new java.lang.Exception
	...
	public org.drip.math.solver1D.BracketingControlParams getCustomBCP()
	{
		return _bcpCustom;
	}
}
