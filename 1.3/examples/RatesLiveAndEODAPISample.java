...
public class RatesLiveAndEODAPISample {
	/**
	...
	public static final void RatesCurveAPISample() throws Exception {
		...
		Set<String> setstrIRCurves = FI.GetEODIRCurveNames (dt1); // Set of IR curves
		...
		DiscountCurve dc = FI.LoadEODFullIRCurve ("EUR", dt1);
		...
		Map<JulianDate, DiscountCurve> mapDC = FI.LoadEODFullIRCurves ("EUR", dt1, dt2);
		...
		DiscountCurve dcCash = FI.LoadEODIRCashCurve ("EUR", dt1);
		...
		Map<JulianDate, DiscountCurve> mapCashDC = FI.LoadEODIRCashCurves ("EUR", dt1, dt2);
		...
		DiscountCurve dcEDF = FI.LoadEODEDFCurve ("EUR", dt1);
		...
		Map<JulianDate, DiscountCurve> mapEDFDC = FI.LoadEODEDFCurves ("EUR", dt1, dt2);
		...
		DiscountCurve dcIRS = FI.LoadEODIRSwapCurve ("EUR", dt1);
		...
		Map<JulianDate, DiscountCurve> mapIRSDC = FI.LoadEODIRSwapCurves ("EUR", dt1, dt2);
		...
		Set<String> setstrTSYCurves = FI.GetEODTSYCurveNames (dt1);
		...
		DiscountCurve dcTSY = FI.LoadEODTSYCurve ("USD", dt1);
		...
		Map<JulianDate, DiscountCurve> mapTSYDC = FI.LoadEODTSYCurves ("USD", dt1, dt2);
